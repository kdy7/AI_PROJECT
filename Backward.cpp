...
void ifSwitch()
{
    switch (sn)
    {
        ...
        case 3: if((strcmp(de, "YES") == 0) && (strcmp(di, "YES") == 0)) s =1;
                break;
        /* if part of statement 4 */
        case 4: if((strcmp(qu, "YES") == 0) && (gr<3.5) && (ex >= 2)) s = 1;
                break;
        /* if part of statement 5 */
        case 5: if((strcmp(qu, "YES") == 0) && (gr<3) && (ex<2)) s = 1;
                break;
        /* if part of statement 6 */
        case 6: if((strcmp(qu, "YES") == 0) && (gr >=3.5)) s = 1;
                break;
    }
}
